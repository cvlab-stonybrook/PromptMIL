...
if __name__ == '__main__':
    ...
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, global_pool='avg')
    ...
    # # model = vit._create_vision_transformer(variant, pretrained=True, **model_kwargs)
    # pretrained_cfg = deepcopy(default_cfgs[variant])
    # model = build_model_with_cfg(
    #     vit.VisionTransformer, variant, True,
    #     pretrained_cfg=pretrained_cfg,
